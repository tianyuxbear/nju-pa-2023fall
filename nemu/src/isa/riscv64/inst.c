...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 00110 11", sraiw  , I, R(rd) = SEXT((int64_t)BITS(src1,31,0) >> BITS(imm, 4, 0), 32));
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 01110 11", sraw   , R, R(rd) = SEXT((int64_t)BITS(src1, 31, 0) >> BITS(src2, 4, 0), 64));
